...
\section*{Results}
In this section, we present results for evaluating statistical significance, phenotype relevance, and predictive performance. In addition to real data, we also evaluated models based on parametric simulations. Results can be found in the Supplemental Materials (\nameref{S1_Fig}, \nameref{S2_Fig}, \nameref{S3_Fig}, \nameref{S4_Fig}, and \nameref{S5_Fig}).   
