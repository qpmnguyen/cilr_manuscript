...
\begin{figure}[!h]
    ...
    \caption{Type I error for sample-level inference with CBEA under different parametric assumptions compared against a Wilcoxon rank-sum test at a nominal $\alpha$ of 0.05. } 
    \label{fig:2}
\end{figure}
